...
from src.slide.synth.gnode import GNode
from src.slide.ppo.parser.PPOLexer import PPOLexer
from src.slide.ppo.parser.PPOParser import PPOParser

MEM_TYPES = ['M', 'RCsc', 'AQ', 'RL', 'R', 'W', 'AMO', 'X', 'AQRL', 'XSc', 'XLr']
RELATIONS = ['rmw', 'addr', 'data', 'ctrl', 'fence', 'po', 'loc', 'rf', 'rfi', 'rsw', 'co', 'coi', 'coe', 'fr', 'po-loc']
