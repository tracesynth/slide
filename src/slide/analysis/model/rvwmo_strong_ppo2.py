...
from src.slide.analysis.rel import PPO
from src.slide.prog import *
...
def ppo_r2_strong(ra, e1: Event, e2: Event) -> bool:
    """
...
rvwmo_global_ppos = [ppo_r1, ppo_r2_strong, ppo_r3, ppo_r4, ppo_r5, ppo_r6, ppo_r7,
                     ppo_r8, ppo_r9,ppo_r10, ppo_r11, ppo_r12, ppo_r13]
rvwmo_local_ppos = [p for p in rvwmo_global_ppos if p not in [ppo_r2_strong, ppo_r3, ppo_r12]]


class RVWMO_STRONG_PPO2(MemoryModel):
