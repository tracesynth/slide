...
from src.slide.utils import dir_util, file_util, list_util, dataframe_util, seaborn_util, regex_util
...
def parse_uniq_states_in_chip_cnt(all_litmus_chip_results, model_name, print_list=True):
    ...
    seaborn_util.draw_single_boxplot(filtered_coverage_df, (6, 8), 'coverage_rate', "", "CX内存模型覆盖率",
                                     fig_output_file)
