...
def get_rvwmo_model_synth():
    RVWMO_model = PPOPool()
    ppo1_1 = SinglePPO([R(), PoLoc(), W()])
    ppo1_2 = SinglePPO([W(), PoLoc(), W()])
    ppo2_1 = SinglePPO([R(), PoLoc(), R()])
    ppo2_2 = SinglePPO([R(), Fri(), W(), Rfi(), R()], ppo_flag = PPOFlag.Relaxed)
    ppo2_3 = SinglePPO([R(), Fri(), W(), PoLoc(), R()], ppo_flag = PPOFlag.Relaxed)
    ppo2_4 = SinglePPO([R(), PoLoc(), W(), Rfi(), R()], ppo_flag = PPOFlag.Relaxed)
    ppo2_5 = SinglePPO([R(), PoLoc(), W(), PoLoc(), R()], ppo_flag = PPOFlag.Relaxed)
    ppo2_6 = SinglePPO([R(), Rsw(), R()], ppo_flag = PPOFlag.Relaxed)
    ...
    ppo5_3 = SinglePPO([AMO(Annotation.AQRL), Po(), R()])
    ppo5_4 = SinglePPO([AMO(Annotation.AQRL), Po(), W()])
    ppo5_5 = SinglePPO([R(), Po(), AMO(Annotation.RL), Rfi(), R(), CtrlD(), W()])
    ppo6_1 = SinglePPO([W(), Po(), AMO(Annotation.RL)])
    ppo6_2 = SinglePPO([R(), Po(), AMO(Annotation.RL)])
    ppo6_3 = SinglePPO([R(), Po(), AMO(Annotation.AQRL)])
    ...
    ppo12_2 = SinglePPO([R(), AddrD(), W(), Rfi(), R(), AddrD(), W()])
    ppo12_3 = SinglePPO([R(), DataD(), W(), Rfi(), R()])
    ppo12_4 = SinglePPO([R(), DataD(), W(), Rfi(), R(), AddrD(), R()])
    ...
    RVWMO_model.add_ppo(ppo2_2, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo2_3, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo2_4, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo2_5, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo2_6, ppo_init_flag=PPOInitFlag.Verified)
    ...
    RVWMO_model.add_ppo(ppo5_1, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo5_2, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo5_3, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo5_4, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo5_5, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo6_1, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo6_2, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo6_3, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo8, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo9_1, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo9_2, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo10_1, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo11_1, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo12_1, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo12_2, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo12_3, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo12_4, ppo_init_flag=PPOInitFlag.Verified)
    RVWMO_model.add_ppo(ppo13_2, ppo_init_flag=PPOInitFlag.Verified)
