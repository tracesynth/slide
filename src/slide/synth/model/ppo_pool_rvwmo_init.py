...
def get_rvwmo_init_model():
    ...
    ppo9_1 = SinglePPO([R(), AddrD(), R()])
    ppo9_2 = SinglePPO([R(), AddrD(), W()])
    ppo9_3 = SinglePPO([R(), AddrD(), R()])
    ppo9_4 = SinglePPO([R(), AddrD(), W()])
    ppo10_1 = SinglePPO([R(), DataD(), R()])
    ppo10_2 = SinglePPO([Sc(), DataD(), W()])
    ppo10_3 = SinglePPO([R(), DataD(), W()])
    ppo10_4 = SinglePPO([Sc(), DataD(), W()])
    ppo11_1 = SinglePPO([R(), CtrlD(), R()])
    ppo11_2 = SinglePPO([Sc(), CtrlD(), W()])
    ppo11_3 = SinglePPO([R(), CtrlD(), W()])
    ppo11_4 = SinglePPO([Sc(), CtrlD(), W()])
    ...
    RVWMO_model.add_ppo(ppo9_3, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo9_4, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo10_1, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo10_2, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo10_3, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo10_4, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo11_1, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo11_2, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo11_3, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo11_4, ppo_init_flag=PPOInitFlag.Init)
    return RVWMO_model