...
def get_rvwmo_model_amo_x(remove = -1):
    RVWMO_model = PPOPool()
    ...
    ppo14_1 = SinglePPO([AMO(Annotation.RL), Po(), R()])
    ppo14_2 = SinglePPO([Lr(), Po(), R()])
    ppo14_3 = SinglePPO([AMO(), Po(), R()])
    ppo14_4 = SinglePPO([R(), Po(), AMO(Annotation.AQ)])
    ppo14_5 = SinglePPO([AMO(), Po(), W()])
    ppo14_6 = SinglePPO([R(), Po(), AMO()])
    ppo14_7 = SinglePPO([Lr(), Po(), W()])
    ppo14_8 = SinglePPO([W(), Po(), Lr()])
    ppo14_9 = SinglePPO([R(), Po(), Lr()])
    ppo14_10 = SinglePPO([W(), Po(), AMO()])
    ...
    RVWMO_model.add_ppo(ppo14_1, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_2, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_3, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_4, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_5, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_6, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_7, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_8, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_9, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppo14_10, ppo_init_flag=PPOInitFlag.Init)
    return RVWMO_model