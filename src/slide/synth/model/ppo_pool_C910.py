...
def get_C910_model():
    ...
    ppoC1 = SinglePPO([W(), FenceD(FenceAnnotation.R_RW), W()])
    ppoC2 = SinglePPO([R(), FenceD(FenceAnnotation.RW_W), R()])
    ppoC3 = SinglePPO([R(), FenceD(FenceAnnotation.W_W), W()])
    ppoC4 = SinglePPO([W(), FenceD(FenceAnnotation.RW_W), R()])
    ppoC5 = SinglePPO([W(), FenceD(FenceAnnotation.R_RW), R()])
    ppoC6 = SinglePPO([R(), FenceD(FenceAnnotation.W_R), R()])
    ppoC7 = SinglePPO([W(), FenceD(FenceAnnotation.TSO), R()])
    ppoC8 = SinglePPO([W(), FenceD(FenceAnnotation.R_R), R()])
    ppoC12 = SinglePPO([R(), Po(), Lr()])
    ppoC13 = SinglePPO([Lr(), Po(), W()])
    ppoC17 = SinglePPO([AMO(Annotation.RL), Po(), W()])
    ppoC18 = SinglePPO([W(), Po(), AMO(Annotation.AQ)])
    ppoC19 = SinglePPO([AMO(), Po(), AMO()])
    ...
    RVWMO_model.add_ppo(ppoC1, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC2, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC3, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC4, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC5, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC6, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC7, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC8, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC12, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC13, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC17, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC18, ppo_init_flag=PPOInitFlag.Init)
    RVWMO_model.add_ppo(ppoC19, ppo_init_flag=PPOInitFlag.Init)
